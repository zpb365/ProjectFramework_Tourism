...
class SpecialtyDetail: CustomTemplateViewController {
    ...
    lazy var sectionIntroduce:UIView = {
        let sectionIntroduce = UIView().headView(width: CommonFunction.kScreenWidth, height: 30, leftViewColor: UIColor().TransferStringToColor("#26C6DA"), title: "特产介绍", titleColor: UIColor.black)
    ...
    var _heightForHeaderInSection = [0,30,50]
    //组头高
    override func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat{
        return CGFloat(_heightForHeaderInSection[section])
    }
    var _numberOfRowsInSection = [5,1,5]
    //组个数
    ...
    func setHeadView() -> Void {
        let titleArray: Array=["特产产品","特产介绍","用户点评"]
